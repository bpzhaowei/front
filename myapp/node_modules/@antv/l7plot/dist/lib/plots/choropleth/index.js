...
var Choropleth = /** @class */ (function (_super) {
    ...
    function Choropleth() {
        ...
        _this.onDrillDownHander = function (event) {
            ...
            var _c = _this.drillSteps[depth], level = _c.level, _d = _c.granularity, granularity = _d === void 0 ? constants_1.DEFAULT_AREA_GRANULARITY[level] : _d, drillConfig = (0, tslib_1.__rest)(_c, ["level", "granularity"]);
            var downParams = {
    ...
    Choropleth.prototype.updateLayers = function (options) {
        ...
        var createCountryBoundaryLayer = function () {
            var _a = _this.createCountryBoundaryLayer(_this.chinaBoundaryData, _this.options), chinaBoundaryLayer = _a.chinaBoundaryLayer, chinaDisputeBoundaryLayer = _a.chinaDisputeBoundaryLayer;
            _this.chinaBoundaryLayer = chinaBoundaryLayer;
            _this.chinaDisputeBoundaryLayer = chinaDisputeBoundaryLayer;
            _this.layerGroup.addLayer(_this.chinaBoundaryLayer);
            _this.layerGroup.addLayer(_this.chinaDisputeBoundaryLayer);
        };
    ...
    Choropleth.prototype.drillUp = function (config, level) {
        ...
        var _a = this.drillStacks[stacksIndex], drillConfig = _a.config, view = (0, tslib_1.__rest)(_a, ["config"]);
        var mergeConfig = (0, utils_1.deepAssign)({}, drillConfig, config);
