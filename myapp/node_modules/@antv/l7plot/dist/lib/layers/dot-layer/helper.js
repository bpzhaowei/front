...
var getColorLegendItems = function (legendItems) {
    ...
    // TODO: scale nice
    var items = legendItems.map(function (item) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { value: [(0, lodash_es_1.round)(item.value[0], 2), (0, lodash_es_1.round)(item.value[1], 2)] })); });
    return items;
};
